...
const isCwdInScope = isPackageExists('@lemonbot.fun/eslint-config');
 ...
 * @example
 * ```ts
 * import { renameRules } from '@lemonbot.fun/eslint-config'
 *
 * export default [{
 *   rules: renameRules(
 *     {
 ...
 * @example
 * ```ts
 * import { renamePluginInConfigs } from '@lemonbot.fun/eslint-config'
